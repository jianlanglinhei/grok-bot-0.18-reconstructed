export function createEgressConnectionObserver<TConnection>() {
  ...
  return {
    wrap<T extends { connect(): Promise<TConnection>; recreate?: (...args: any[]) => any; forceRecreate?: (...args: any[]) => any; issueLocalExecDaemonCredential?: (...args: any[]) => any; listRoutedComputerTools?: (...args: any[]) => any; executeRoutedComputerTool?: (...args: any[]) => any }>(base: T) {
      return {
        ...
        ...(base.listRoutedComputerTools == null ? {} : { listRoutedComputerTools: base.listRoutedComputerTools.bind(base) }),
        ...(base.executeRoutedComputerTool == null ? {} : { executeRoutedComputerTool: base.executeRoutedComputerTool.bind(base) }),
