...
export const BOX_MCP_UNSUPPORTED_MESSAGE = "onebot's computer is running an older image without MCP support — update it from Settings → Updates → Update onebot's Computer.";
