...
export const SAND_SHORTLIVED_CREDS_WAITING_MESSAGE = "Waiting for an inference credential. onebot's computer renews this automatically (no desktop required); this resolves on its own shortly.";
