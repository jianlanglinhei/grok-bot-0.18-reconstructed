  ...
  return (
    <section className="sand-auto-review">
      <SandSwitch
        ...
        disabled={isDisabled}
        label={<span><strong>Auto-review</strong><small>onebot checks each action before it runs and asks you first when needed. Add rules to customize what it can do automatically.</small></span>}
