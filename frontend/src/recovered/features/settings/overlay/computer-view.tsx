...
const BLOCKED_COPY = "Further computer updates and resets are disabled for this session. Restart onebot after the computer is available again.";
...
export function SettingsComputerPanel({ state, actions }: SettingsComputerMount) {
  ...
  return (
    <SettingsGroup title="onebot's Computer">
      {phase === "up-to-date" && !state.isRebuildBlocked ? (
        ...
        <SettingsComputerRow
          ...
          label="Update onebot's Computer"
